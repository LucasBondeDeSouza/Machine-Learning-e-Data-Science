...
# Armazenando os dados com o pickle:
# - Após pré-processar os dados e dividi-los em treinamento e teste,
#   vamos salvar esses dados em um arquivo binário. Isso evita a necessidade
#   de repetir todo o pré-processamento no futuro, economizando tempo.

# O arquivo será salvo com o nome 'census.pkl' usando a biblioteca pickle.
# O modo 'wb' (write binary) indica que o arquivo será escrito em formato binário.
with open('census.pkl', mode = 'wb') as f:
    # pickle.dump salva os dados divididos (treinamento e teste) no arquivo.
    # Lista contendo:
    # 1. x_census_treinamento: entradas de treinamento
    # 2. y_census_treinamento: saídas de treinamento
    # 3. x_census_teste: entradas de teste
    # 4. y_census_teste: saídas de teste
    pickle.dump(
